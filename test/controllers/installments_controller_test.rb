...
class InstallmentsControllerTest < ActionController::TestCase
  ...
  test "should create installment" do
    assert_difference('Installment.count') do
      post :create, installment: { amount: @installment.amount, building_id: @installment.building_id, details: @installment.details, installment_date: @installment.installment_date, status: @installment.status }
    end
  ...
  test "should update installment" do
    patch :update, id: @installment, installment: { amount: @installment.amount, building_id: @installment.building_id, details: @installment.details, installment_date: @installment.installment_date, status: @installment.status }
    assert_redirected_to installment_path(assigns(:installment))
  end
